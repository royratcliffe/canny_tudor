...
\chapter{library(swi/ord)}\label{sec:ord}

\begin{description}
    \predicate[det]{iud}{5}{+Existing:list, +Incoming:list, -Inserts:list, -Updates:list, -Deletes:list}
Take two payload lists, \arg{Existing} and \arg{Incoming}. First convert to
